...
#=============
	...
	if ( moduleCfgs )
		foreach( moduleCfg ${moduleCfgs} )
			...
			IF (OPT_ENABLE_SHAWN_WEB) #if the ShawnWeb is ON
			
			if ( CONFIGURE_${appsType} )
 				if("${appsType}" STREQUAL "LEGACYAPPS")
					if( "${USER_MODULE_NAME}" STREQUAL "${moduleNameLower}" )
					option ( MODULE_${appsType}_${moduleName} "Activate module ${moduleName}" ON )
					set ( MODULE_${appsType}_${moduleName} ON )
					else ("${USER_MODULE_NAME}" STREQUAL "${moduleNameLower}")
					option( MODULE_${appsType}_${moduleName} "Activate module ${moduleName}" OFF ) #default user application off
					set ( MODULE_${appsType}_${moduleName} OFF )
					endif( "${USER_MODULE_NAME}" STREQUAL "${moduleNameLower}" )				
				else("${appsType}" STREQUAL "LEGACYAPPS")
				option( MODULE_${appsType}_${moduleName} "Activate module ${moduleName}" ${moduleStatus} )
				endif("${appsType}" STREQUAL "LEGACYAPPS")
